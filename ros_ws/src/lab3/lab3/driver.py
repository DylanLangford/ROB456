...
# YOUR CODE HERE
        # DOC 
        # Simple code to check if we're within the threshold distance of the goal. 
    ...
    def get_obstacle(self, scan):
        ...
        #Check if scan is valid, append to front_ranges and front_angles if within the front angle
